...
class CarouselLayoutManager constructor(
    ...
    /**
     * Provides the center position of current display area, this method used in the [Carousel.getChildDrawingOrder]
     ...
     * It's also used in the [Carousel.getChildDrawingOrder] for measure the order of the child
     */
